...
def data_mining(data_excel_path, sap_excel_path):
    ...
    sheet_out.cell(sheet.max_row + 1 + 5, 6).value = '=1.051*F' + str(sheet.max_row + 1 + 2) + '+F' + str(sheet.max_row + 1 + 3)

    sheet_out.cell(sheet.max_row + 1 + 6, 5).value = 'CM2'
    sheet_out.cell(sheet.max_row + 1 + 6, 6).value = '=100*(F' + str(sheet.max_row + 1 + 4) + '-F' + str(sheet.max_row + 1 + 5) + ')/F' + str(sheet.max_row + 1 + 5)
    # 100 * (PTC - HK) / HK
    ...
    output_excel_wb.save('output.xlsx')
